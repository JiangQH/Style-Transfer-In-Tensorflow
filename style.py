from src.optimize.optimize import StyleTransfer
import argparse
...
parser.add_argument('-m', '--model_dirs', type=str, required=True, help='path to the model dir')
...
def main(args):
	transfer = StyleTransfer(args.content_img, args.style_img,
							 args.model_dirs, args.gpu_id, args.init, args.max_iter,
							 args.verbose)
	transfer.transfer()
