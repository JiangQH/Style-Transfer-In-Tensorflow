...
<img src = 'examples/styled/flower.png' height = '200px'>
</div>
...
``python fast_style.py -m <path to the pre-trained model dir> -i <folders contain image want to transfer> -o <output dir>``     
